...
public class AnalizadorLexico {
	...
	private void setPalabrasClaves() {
		...
		claves.put("class", "class");
		claves.put("String", "String");
		claves.put("public", "public");
		claves.put("if", "if");
		claves.put("this", "this");
		claves.put("extends", "extends");
		claves.put("boolean", "boolean");
		claves.put("private", "private");
		claves.put("else", "else");
		claves.put("new", "new");
		claves.put("static", "static");
		claves.put("char", "char");
		claves.put("void", "void");
		claves.put("while", "while");
		claves.put("true", "true");
		claves.put("dynamic", "dynamic");
		claves.put("int", "int");
		claves.put("null", "null");
		claves.put("return", "return");
		claves.put("false", "false");
	}
		...
		try{
			...
			while (t == null) {
				...
				case "q0":
					...
					// fin de archivo
					if (esFin(actual)) {
						return new Token("eof","fin de archivo",fuente.getLinea(),fuente.getColumna());
				...
				case "q22":
					...
					t = new Token("(", lexema, fuente.getLinea(), this.columna_lexico);
					this.reiniciar();
					break;
